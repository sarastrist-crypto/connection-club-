...
import {
  ...
  Globe, Smartphone, Award, DollarSign
} from 'lucide-react';
...
export default function MarketplacePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [platformsRes, bundlesRes] = await Promise.all([
    ...
    <Layout>
      <div className="space-y-6" data-testid="marketplace">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-medium tracking-tight">Opportunity Marketplace</h1>
